...
fn signal_to_string(signal: u32) -> String {
    match signal {
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_ZDO_SIGNAL_DEFAULT_START => return "ZDO_SIGNAL_DEFAULT_START".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_ZDO_SIGNAL_SKIP_STARTUP => return "ZDO_SIGNAL_SKIP_STARTUP".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_ZDO_SIGNAL_DEVICE_ANNCE => return "ZDO_SIGNAL_DEVICE_ANNCE".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_ZDO_SIGNAL_LEAVE => return "ZB_ZDO_SIGNAL_LEAVE".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_ZDO_SIGNAL_ERROR => return "ZB_ZDO_SIGNAL_ERROR".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_BDB_SIGNAL_DEVICE_FIRST_START => return "ZB_BDB_SIGNAL_DEVICE_FIRST_START".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_BDB_SIGNAL_DEVICE_REBOOT => return "ZB_BDB_SIGNAL_DEVICE_REBOOT".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_BDB_SIGNAL_TOUCHLINK_NWK_STARTED => return "ZB_BDB_SIGNAL_TOUCHLINK_NWK_STARTED".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_BDB_SIGNAL_TOUCHLINK_NWK_JOINED_ROUTER => return "ZB_BDB_SIGNAL_TOUCHLINK_NWK_JOINED_ROUTER ".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_BDB_SIGNAL_TOUCHLINK => return "ZB_BDB_SIGNAL_TOUCHLINK".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_BDB_SIGNAL_STEERING => return "ZB_BDB_SIGNAL_STEERING".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_BDB_SIGNAL_FORMATION => return "ZB_BDB_SIGNAL_FORMATION".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_BDB_SIGNAL_FINDING_AND_BINDING_TARGET_FINISHED => return "ZB_BDB_SIGNAL_FINDING_AND_BINDING_TARGET_FINISHED".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_BDB_SIGNAL_FINDING_AND_BINDING_INITIATOR_FINISHED => return "ZB_BDB_SIGNAL_FINDING_AND_BINDING_INITIATOR_FINISHED".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_BDB_SIGNAL_TOUCHLINK_TARGET => return "ZB_BDB_SIGNAL_TOUCHLINK_TARGET".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_BDB_SIGNAL_TOUCHLINK_NWK => return "ZB_BDB_SIGNAL_TOUCHLINK_NWK".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_BDB_SIGNAL_TOUCHLINK_TARGET_FINISHED => return "ZB_BDB_SIGNAL_TOUCHLINK_TARGET_FINISHED".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_BDB_SIGNAL_TOUCHLINK_ADD_DEVICE_TO_NWK => return "ZB_BDB_SIGNAL_TOUCHLINK_ADD_DEVICE_TO_NWK".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_NWK_SIGNAL_DEVICE_ASSOCIATED => return "ZB_NWK_SIGNAL_DEVICE_ASSOCIATED".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_ZDO_SIGNAL_LEAVE_INDICATION => return "ZB_ZDO_SIGNAL_LEAVE_INDICATION".to_string(),
        esp_idf_svc::sys::esp_zb_app_signal_type_t_ESP_ZB_BDB_SIGNAL_WWAH_REJOIN_STARTED => return "ZB_BDB_SIGNAL_WWAH_REJOIN_STARTED".to_string(),
